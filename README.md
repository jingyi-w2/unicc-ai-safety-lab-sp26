...
│   ├── judge1.py                # Technical Safety Judge
│   ├── judge2.py                # Governance and Policy Judge
│   ├── judge3.py                # Operational Risk Judge
│   ├── main.py                  # Main pipeline entry point
│   ├── models.py                # Shared data models
│   ├── orchestrator.py          # Workflow coordination
│   ├── runtime_config.py        # Runtime and model configuration
│   └── synthesis.py             # Final integrated recommendation
├── data/                        # Sample submission input
│   └── sample_submission.json   # Demo evaluation case
├── tests/                       # Testing scripts
│   └── test_scoring.py          # Scoring validation
├── demo.py                      # Streamlit frontend interface
├── .env.example                 # Environment variable template
├── Makefile                     # Run and setup shortcuts
